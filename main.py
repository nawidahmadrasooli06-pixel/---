...
from handlers.owner import stars_toggle_callback, preview_callback, day_callback, timezone_callback
...
def create_application():
    ...
    app.add_handler(CallbackQueryHandler(preview_callback, pattern=r"^preview_(confirm|cancel)$"))
...
async def post_init(app):
    await app.bot.set_my_commands([BotCommand("start", "باز کردن منوی ربات"), BotCommand("stats", "آمار ربات (مدیر)")])
